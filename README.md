# AURA-BCI: Real-Time Single-Sensor EEG Classification Dashboard

AURA-BCI is a comprehensive machine learning pipeline and real-time dashboard designed to classify binary cognitive states (Not Confused vs. Confused) from single-channel EEG signals.
